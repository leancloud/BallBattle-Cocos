(function (global, factory) {
	  ...
	  function GameConnection() {_classCallCheck(this, GameConnection);var _this = _possibleConstructorReturn(this, (GameConnection.__proto__ || _Object$getPrototypeOf(GameConnection)).call(this));
	    ...
	    _this._flag = 'game';return _this;
	      ...
	      roomName, matchProperties, expectedUserIds) {var msg, res;return regenerator.wrap(function _callee3$(_context3) {while (1) {switch (_context3.prev = _context3.next) {case 0:
	                ...
	                msg, undefined, false);case 3:case 'end':return _context4.stop();}}}, _callee4, this);}));function leaveRoom() {return _ref4.apply(this, arguments);}return leaveRoom;}() }, { key: 'setRoomOpened', value: function setRoomOpened(
	...
	var PlayFSM = machina.Fsm.extend({
	    ...
	    game: {
	      _onEnter: function _onEnter() {var _this4 = this;
	        ...
	        this._gameConn.on(ROOM_OPEN_CHANGED_EVENT, function (open) {
	          _this4._play._room._opened = open;
	      ...
	      setRoomOpened: function setRoomOpened(opened) {var _this6 = this;
	        return this._gameConn.setRoomOpened(opened).then(
	        tap(function (res) {var
	          toggle = res.toggle;
	          _this6._play._room._opened = toggle;
	        }));
	      ...
	      setRoomVisible: function setRoomVisible(visible) {var _this7 = this;
	        ...
	        tap(function (res) {var
	          toggle = res.toggle;
	          _this7._play._room._visible = toggle;
	        }));

	      },

	      setMaster: function setMaster(newMasterId) {var _this8 = this;
	        return this._gameConn.setMaster(newMasterId).then(
	        tap(function (res) {var
	          masterActorId = res.masterActorId;
	          _this8._play._room._masterActorId = masterActorId;
	        }));

	      },

	      kickPlayer: function kickPlayer(actorId, code, msg) {var _this9 = this;
	        return this._gameConn.kickPlayer(actorId, code, msg).then(
	        tap(function (res) {var
	          targetActorId = res.targetActorId;
	          _this9._play._room._removePlayer(targetActorId);
	        }));
	      ...
	      setRoomCustomProperties: function setRoomCustomProperties(properties, expectedValues) {var _this10 = this;
	      ...
	      setPlayerCustomProperties: function setPlayerCustomProperties(actorId, properties, expectedValues) {var _this11 = this;
	        return this._gameConn.
	  ...
	  _initGame: function _initGame(gameRoom) {var _this24 = this;
	    this._play._room = gameRoom;
	    gameRoom._play = this._play;
	    /* eslint no-param-reassign: ["error", { "props": false }] */
	    lodash.forEach(gameRoom.playerList, function (player) {
	      player._play = _this24._play;
	      if (player.userId === _this24._play._userId) {
	        _this24._play._player = player;
	      }
	    });
	  } });
	...
	Client = function (_EventEmitter) {_inherits(Client, _EventEmitter);
	  ...
	  /**
	    ...
	    /**
	        ...
	        {},_ref15$matchPropertie = _ref15.matchProperties,matchProperties = _ref15$matchPropertie === undefined ? null : _ref15$matchPropertie,_ref15$expectedUserId = _ref15.expectedUserIds,expectedUserIds = _ref15$expectedUserId === undefined ? null : _ref15$expectedUserId;return regenerator.wrap(function _callee11$(_context11) {while (1) {switch (_context11.prev = _context11.next) {case 0:if (!(
	                matchProperties !== null && !((typeof matchProperties === 'undefined' ? 'undefined' : _typeof(matchProperties)) === 'object'))) {_context11.next = 2;break;}throw (
	                  new TypeError(matchProperties + ' is not an object'));case 2:if (!(

	                expectedUserIds !== null && !Array.isArray(expectedUserIds))) {_context11.next = 4;break;}throw (
	                  new TypeError(expectedUserIds + ' is not an array with string'));case 4:return _context11.abrupt('return',

	                this._fsm.handle('joinRandomRoom', matchProperties, expectedUserIds));case 5:case 'end':return _context11.stop();}}}, _callee11, this);}));function joinRandomRoom() {return _ref14.apply(this, arguments);}return joinRandomRoom;}()


	    /**
	                                                                                                                                                                                                                                                       * 设置房间开启 / 关闭
	                                                                                                                                                                                                                                                       * @param {Boolean} opened 是否开启
	                                                                                                                                                                                                                                                       */ }, { key: 'setRoomOpened', value: function () {var _ref16 = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee12(
	      opened) {return regenerator.wrap(function _callee12$(_context12) {while (1) {switch (_context12.prev = _context12.next) {case 0:if (
	                typeof opened === 'boolean') {_context12.next = 2;break;}throw (
	                  new TypeError(opened + ' is not a boolean value'));case 2:if (!(

	                this._room === null)) {_context12.next = 4;break;}throw (
	                  new Error('room is null'));case 4:return _context12.abrupt('return',

	                this._fsm.handle('setRoomOpened', opened));case 5:case 'end':return _context12.stop();}}}, _callee12, this);}));function setRoomOpened(_x8) {return _ref16.apply(this, arguments);}return setRoomOpened;}()


	    /**
	                                                                                                                                                                                                                             * 设置房间可见 / 不可见
	                                                                                                                                                                                                                             * @param {Boolean} visible 是否可见
	                                                                                                                                                                                                                             */ }, { key: 'setRoomVisible', value: function () {var _ref17 = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee13(
	      visible) {return regenerator.wrap(function _callee13$(_context13) {while (1) {switch (_context13.prev = _context13.next) {case 0:if (
	                typeof visible === 'boolean') {_context13.next = 2;break;}throw (
	                ...
	                this._fsm.handle('setRoomVisible', visible));case 5:case 'end':return _context13.stop();}}}, _callee13, this);}));function setRoomVisible(_x9) {return _ref17.apply(this, arguments);}return setRoomVisible;}()
	    ...
	    /**
	      ...
	      newMasterId) {return regenerator.wrap(function _callee14$(_context14) {while (1) {switch (_context14.prev = _context14.next) {case 0:if (
	                ...
	                this._fsm.handle('setMaster', newMasterId));case 5:case 'end':return _context14.stop();}}}, _callee14, this);}));function setMaster(_x10) {return _ref18.apply(this, arguments);}return setMaster;}()
	    ...
	    /**
	      ...
	      eventId) {var
	        ...
	        options = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : { receiverGroup: ReceiverGroup.All };return regenerator.wrap(function _callee15$(_context15) {while (1) {switch (_context15.prev = _context15.next) {case 0:if (!(
	                ...
	                (typeof eventData === 'undefined' ? 'undefined' : _typeof(eventData)) === 'object') {_context15.next = 4;break;}throw (
	                  new TypeError(eventData + ' is not an object'));case 4:if (

	                options instanceof Object) {_context15.next = 6;break;}throw (
	                  new TypeError(options + ' is not a Object'));case 6:if (!(


	                options.receiverGroup === undefined &&
	                options.targetActorIds === undefined)) {_context15.next = 8;break;}throw (

	                  new TypeError('receiverGroup and targetActorIds are null'));case 8:if (!(

	                this._room === null)) {_context15.next = 10;break;}throw (
	                  new Error('room is null'));case 10:if (!(
	    ...
	    /**
	                                                                                                                                                                                                      ...
	                                                                                                                                                                                                      * @param {Number} [opts.code] 编码
	                                                                                                                                                                                                      * @param {String} [opts.msg] 附带信息
	                                                                                                                                                                                                      */ }, { key: 'kickPlayer', value: function () {var _ref21 = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee17(
	      actorId) {var _ref22 = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},_ref22$code = _ref22.code,code = _ref22$code === undefined ? null : _ref22$code,_ref22$msg = _ref22.msg,msg = _ref22$msg === undefined ? null : _ref22$msg;return regenerator.wrap(function _callee17$(_context17) {while (1) {switch (_context17.prev = _context17.next) {case 0:if (
	                lodash.isNumber(actorId)) {_context17.next = 2;break;}throw (
	                  new TypeError(actorId + ' is not a number'));case 2:if (!(

	                !lodash.isNull(code) && !lodash.isNumber(code))) {_context17.next = 4;break;}throw (
	                  new TypeError(code + ' is not a number'));case 4:if (!(

	                !lodash.isNull(msg) && !lodash.isString(msg))) {_context17.next = 6;break;}throw (
	                  new TypeError(msg + ' is not a string'));case 6:return _context17.abrupt('return',

	                this._fsm.handle('kickPlayer', actorId, code, msg));case 7:case 'end':return _context17.stop();}}}, _callee17, this);}));function kickPlayer(_x15) {return _ref21.apply(this, arguments);}return kickPlayer;}()
